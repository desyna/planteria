  ...
  <div class="web-1-screens2">
    ...
    <section class="web-1-screens-child">
      ...
      <div class="frame-item">
        <form id="form1" name="form1" class="form" method="post" action="indication.php">
        ...
        <a href="inputindication.php"><button type="button" class="btn btn-default">
              ...
              if ($_POST['tanaman'] != "jenistanaman") {
                ...
                while ($data = mysqli_fetch_array($hasil)) {
                  ...
                  <tr>  
                    ...
                    <td>" . $data[2] . "</td>
                    <td>" . $data[3] . "</td>
                    <td><a href=\"editindicator.php?id=" . $data[0] . "\"><i class='glyphicon glyphicon-pencil'></i></a>" . " || <a href=\"../services/deleteindicator.php?id=" . $data[0] . "\"  onclick='return checkDelete()'><i class='glyphicon glyphicon-trash'></i></a>" . "</td>
                  </tr>";
                }
              }
            ?>
